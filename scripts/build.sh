#!/usr/bin/env bash
# Builds GitEnough.app from the command line and reveals it in Finder on success.
...
set -euo pipefail
export BUILD_APP_NAME="GitEnough"
export BUILD_KIND="xcode"
export BUILD_XCODE_PROJECT="GitEnough.xcodeproj"
export BUILD_XCODE_SCHEME="GitEnough"
